...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function proximoNivel() {
        ...
        if (jogadas < 2) {
            ...
            if (operacao === 'soma') {
                perguntaElement.innerText = `Qual é a soma dos dados apresentados?`;
                ...
                perguntaElement.innerText = `Qual é a subtração dos dados apresentados?`;
                if (dificuldadeSelecionada === "normal") {
    ...
    function atualizarBarraProgresso() {
        let progressoTotal;
        if (nivelAtual === 1) {
            // Nível 1 tem 2 etapas, portanto cada jogada representa 1/5 (20%) do progresso total
            progressoTotal = (jogadas / 5) * 100;
        } else {
            // Nível 2 tem 3 etapas, então as duas primeiras etapas do nível 1 são 2/5 (40%) do progresso total
            // e cada jogada no nível 2 é 1/5 (20%) do progresso total
...
// Evento para reiniciar o jogo da memória
document.getElementById('reiniciarMemoria').addEventListener('click', iniciarJogoMemoria);
